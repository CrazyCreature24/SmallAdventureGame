...
bgfx::VertexLayout VertexFormat_PosUV3D::format;
bgfx::VertexLayout VertexFormat_PosUVNormal::format;

void InitVertexFormats()
{
    VertexFormat_PosColor::InitVertexLayout();
    VertexFormat_PosUV::InitVertexLayout();
    VertexFormat_PosUV3D::InitVertexLayout();
    VertexFormat_PosUVNormal::InitVertexLayout();
}
